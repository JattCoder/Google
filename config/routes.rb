Rails.application.routes.draw do
  ...
  get 'account_menu/business/:name/:address', to: 'business#sel_biz'
  ...
  post 'account_menu/business/new_item', to:'item#new', as:'additem'
  get 'account_menu/business/new_item', to:'item#new'
  post 'account_menu/business/finalize_item', to:'item#add', as:'addtobiz'
  get 'account_menu/business/finalize_item', to:'item#add'
  post 'account_menu/business/location', to:'gmap#single_biz_view', as:'showbiz'
